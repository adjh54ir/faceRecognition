...
export class TensorFlowWaterfallComponent extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      net: null,
...
export default TensorFlowWaterfallComponent;
...
export class App extends React.Component {
  ...
  render() {
    return (
      ...
      <div className="row">
        <div className="col-lg-12 container1" >
          <TensorFlowWaterfallComponent height={468} width={640} />
        </div>
      </div>
